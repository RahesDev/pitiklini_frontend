                        ...
                        <div className="form_div boder-none  support-form-div">
                          ...
                          <div>
                            {buttonLoader == false ? (
                              ...
                              <button className="w-full h-[56px] bg-primary text-secondary rounded-lg text-lg font-medium hover:opacity-90 transition">
                                {t("loading")} ...
                              </button>
                            )}
                          </div>
                  ...
                  <table className="table ">
                    <thead>
                      <tr className="stake-head">
                        <th>{t("ticketID")}</th>
                        <th className="table_center_text">{t("subject")}</th>
                        <th className="table_center_text">{t("message")}</th>
                        <th className="table_center_text">{t("category")}</th>
                        <th className="table_center_text ">{t("dateTime")}</th>
                      ...
                      {user.length > 0 ? (
                        user.map((data, i) => (
                          <tr>
                            ...
                            >
                              <button class="action_btn">{t("view")}</button>
                            </td>
                          </tr>
                        ))
                      ) : (
