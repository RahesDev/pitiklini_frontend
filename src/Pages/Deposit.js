          ...
          var obj = {
            ...
            content: (
              <span className="inline-block align-middle ml-1">
                <span className="font-bold text-white text-[15px]">{data[i].currencySymbol}</span>
                <span className="text-[#848E9C] font-normal text-[14px] ml-2">{data[i].currencyName}</span>
              </span>
            ),
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                              <div className="bg-[#181a20] border border-gray-800 rounded-lg p-4">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <h3 className="text-[#f0b90b] font-medium text-sm">{t("Copy the wallet address")}</h3>
                                </div>
                                <p className="text-xs text-gray-400">{t("Select crypto, network & copy address.")}</p>
                              </div>
                              <div className="bg-[#181a20] border border-gray-800 rounded-lg p-4">
                                <div className="flex items-center gap-3 mb-2">
                                ...
                                <p className="text-xs text-gray-400">{t("Paste address on other exchange.")}</p>
                              </div>
                              <div className="bg-[#181a20] border border-gray-800 rounded-lg p-4">
                                <div className="flex items-center gap-3 mb-2">
                                ...
                                <p className="text-xs text-gray-400">{t("Await blockchain confirmation for transfer.")}</p>
                              </div>
                              <div className="bg-[#181a20] border border-gray-800 rounded-lg p-4">
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="bg-[#f0b90b] px-2 py-0.5 text-[#181a20] rounded text-sm font-bold">4</span>
                                  <h3 className="text-[#f0b90b] font-medium text-sm">{t("Successful Deposit")}</h3>
                                </div>
                                <p className="text-xs text-gray-400">{t("Pitikulini will send assets to wallet.")}</p>
                              </div>
                            </div>
                              ...
                              <div className="flex-[2]">
                                <div className="relative pl-8 sm:pl-10 border-l-[1px] border-[#8c6b16] ml-4 space-y-12 pb-8">
                                  ...
                                  <div className="relative">
                                    <div className="absolute -left-[53px] sm:-left-[61px] top-0 bg-[#f0b90b] p-[6px] rounded-md z-10">
                                  ...
                                  {/* Step 2 */}
                                  <div className="relative">
                                    <div className="absolute -left-[53px] sm:-left-[61px] top-0 bg-[#f0b90b] p-[6px] rounded-md z-10 transition-colors">
                                      <svg className="w-5 h-5 text-[#181a20]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                                    </div>
                                    <h3 className="text-white font-medium mb-4 text-lg">{t("Select Network")}</h3>
                                  ...
                                  <div className="relative">
                                    <div className="absolute -left-[53px] sm:-left-[61px] top-0 bg-[#f0b90b] p-[6px] rounded-md z-10">
                                      <svg className="w-5 h-5 text-[#181a20]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2"></path></svg>
                                    </div>
                                    ...
                                    <h3 className="text-white font-medium mb-4 text-lg">{t("Copy Wallet Address")}</h3>
                              ...
                              <div className="flex-1 lg:ml-10 mt-10 lg:mt-0">
                                <div className="mb-10">
                                  ...
                                  <div className="space-y-6 text-[13px] text-[#A0AEC0] border-t border-gray-800 pt-6">
                                    <p className="leading-relaxed">{t("For the safety of your funds, our customer support team may contact you by phone to confirm your withdrawal")}</p>
                                    <p className="leading-relaxed">{t("For the safety of your funds, our customer support team may contact you by phone to confirm your withdrawal")}</p>
                                  </div>
                                </div>
                                ...
                                <div className="mt-12">
                                  <div className="flex items-center justify-between mb-6">
                                    ...
                                    <Link to="/faq" className="text-gray-400 text-[13px] flex items-center hover:text-white transition-colors">
                                      {t("View more")}
                                      <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
                                    </Link>
                                  </div>
                                  <div className="space-y-5 border-t border-gray-800 pt-6">
                                    <Link to="/faq" className="flex items-start gap-4 text-[14px] text-[#A0AEC0] hover:text-white transition-colors group">
                                      <svg className="w-5 h-5 mt-0.5 text-gray-500 group-hover:text-gray-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20z"></path></svg>
                          ...
                          <div className="mt-8 mb-10 w-full">
                            <div className="flex justify-between items-center mb-6">
                              <h2 className="text-[#ca9b27] text-xl font-medium">
                                {t("Last 4 Deposit Records")}
                              </h2>
                              <Link to="/depositHistory">
                                <button className="bg-[#ca9b27] hover:bg-[#b58a23] text-[#181a20] font-medium px-4 py-2 rounded transition-colors text-[13px] tracking-wide">
                                  {t("Deposit History")}
                                </button>
                              </Link>
                            </div>
                            ...
                            <div className="bg-[#1e2329] rounded-lg overflow-hidden">
                              <div className="overflow-x-auto">
                                <table className="w-full text-left border-collapse">
                                  <thead>
                                    <tr className="bg-[#242930] text-[#ca9b27] text-[13px]">
                                      <th className="py-4 px-6 font-medium tracking-wide">{t("Date/Time")}</th>
                                      <th className="py-4 px-6 font-medium tracking-wide">{t("Coin")}</th>
                                      <th className="py-4 px-6 font-medium tracking-wide">{t("Amount")}</th>
                                      <th className="py-4 px-6 font-medium tracking-wide">{t("Blockchain Record")}</th>
                                      <th className="py-4 px-6 font-medium tracking-wide">{t("Remarks")}</th>
                                      <th className="py-4 px-6 text-center font-medium tracking-wide">{t("Action")}</th>
                                    </tr>
                                  </thead>
                                    ...
                                    {historyLoader == false ? (
                                      <>
                                        {depositHistory && depositHistory.length > 0 ? (
                                          depositHistory.slice(0, 4).map((item, i) => {
                                            return (
                                              <tr key={i} className="border-b border-[#2b3139] hover:bg-[#2b3139] transition-colors">
                                                <td className="py-4 px-6 text-gray-300">
                                                  {Moment(item.date).format("DD/MM/YY - HH:mm:ss")}
                                                </td>
                                                <td className="py-4 px-6">
                                                  <div className="flex items-center gap-2">
                                                    <span className="text-white font-bold text-base tracking-wide">{item.currencySymbol}</span>
                                                    <span className="text-gray-500 text-xs mt-0.5">{item.currencySymbol === "USDT" ? "Tether" : item.currencySymbol === "BTC" ? "Bitcoin" : item.currencySymbol}</span>
                                                  </div>
                                                </td>
                                                <td className="py-4 px-6 text-gray-300">
                                                ...
                                                <td className="py-4 px-6 text-gray-300 flex items-center gap-2">
                                                  <i
                                                    className="ri-file-copy-line text-gray-400 hover:text-[#ca9b27] cursor-pointer transition-colors text-lg"
                                          ...
                                          <tr>
                                            <td colSpan={6} className="text-center py-10">
                                              <div className="flex flex-col items-center justify-center">
                                                <img src={require("../assets/No-data.webp")} width="100px" alt="No data" />
                                                <div className="text-gray-400 mt-4 text-sm">{t("noRecordsFound")}</div>
                                              </div>
                                            </td>
                                          </tr>
                                        )}
                                      ...
                                      <tr>
                                        <td colSpan={6} className="text-center py-10">
                                          <div className="flex justify-center">
                                            <Bars height="40" width="40" color="#bd7f10" ariaLabel="bars-loading" visible={true} />
                                          </div>
                                        </td>
                                      </tr>
                                    )}
