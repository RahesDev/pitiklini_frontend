                              ...
                              bankDataref.current ? (
                                <div className="color_border ne_bg_txt">
                                  <div className="pay-wrapper">
                                    ...
                                    <div className="pay-flex">
                                      <span className="pay-name">{t('ifscCode')}</span>
                                      <span className="pay-money">
                                        {" "}
                  ...
                  {disputeDetailsref.current.status === "raised" && remainingSeconds != null ? (<>
                    <div className="modal-body personal_verify_body lvl-one-body">
                      <div className="mar-top-12">
                        <h4 className="modal-title mb-4">Appeal submitted. Awaiting response from other party.</h4>
                        <p className="select_id_text mb-3">
                          The other party must respond within: {Math.floor(remainingSeconds / 60)}m {remainingSeconds % 60}s
                        </p>

                        <ol>
                          <li className="select_id_text1 mb-3">If both parties agree, click <b>Cancel Appeal</b>.</li>
                          <li className="select_id_text1 mb-3">If no response in 20 minutes, arbitration starts.</li>
                          <li className="select_id_text1 mb-3">You can upload more evidence anytime.</li>
                        </ol>
                    ...
                    <div className="modal-body personal_verify_body lvl-one-body">
                      <div className="mar-top-12">
                        <h4 className="modal-title mb-4">Issues Resolved</h4>
                    ...
                    <div className="modal-body personal_verify_body lvl-one-body">
                      <div className="mar-top-12">
                        <h4 className="modal-title mb-4">Awaiting Assistance from Customer Service</h4>
                        <p className="select_id_text mb-3">
                        ...
                        <div className="mar-top-12">
                          {remainingSeconds === null && (
                            ...
                            <div className="first_name">
                              <h4 className="modal-title mb-4">Raise Help</h4>

                              <h4 className="select_id_text">Experiencing problems?</h4>
                              <Dropdown
                                placeholder="Select a Appeal reason"
                                fluid
                                selection
                                className="dep-drops"
                          ...
                          {disputeReason && !appealstatus && remainingSeconds === null && (
                            <div className="first_name mt-3">
                              <h4 className="select_id_text1">You can try to resolve the issue by following these steps:</h4>
                              <h4 className="select_id_text">1. Make sure your account information is correct.</h4>
                              <h4 className="select_id_text">2. Check the  {orderTyperef.current == "Buy" ? "seller's" : "buyer's"} payment proof or chat with them for clarification.</h4>
                              <h4 className="select_id_text">3. Some payment methods may take 1–3 days to complete.</h4>
                              <h4 className="select_id_text1">* If the issue remains, you can initiate an appeal.</h4>
                        ...
                        <div className="mar-top-12">
                          {remainingSeconds === null && (
                            ...
                            <div className="first_name">
                              ...
                              <h4 className="select_id_text">Experiencing problems?</h4>
                              <Dropdown
                                placeholder="Select a dispute reason"
                                fluid
                                selection
                                className="dep-drops"
                                options={disputeReasonOptions}
