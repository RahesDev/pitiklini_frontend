        ...
        {siteLoader == true ? (
          ...
          <section className="asset_section">
            <div className="buy_head">
              <div className="asset_title">{t("fundingAssets")}</div>
                    ...
                    <div className="esti-left">
                      ...
                      <span className="esti-num">
                        ...
                        {isBalanceVisible ? (
                          <>
                            {totalFundingINR == "" ||
                            totalFundingINR == null ||
                            totalFundingINR == undefined
                              ? 0.0
                              : totalFundingINR.toFixed(4)}
                          </>
                        ) : (
                          "****"
                        )}{" "}
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        {balanceDetails && balanceDetails.length > 0 ? (
                          balanceDetails
                            .filter((item) => !isChecked || item.p2p > 0)
                            .map((item, i) => {
                              return (
                                <tr key={i}>
                                  ...
                                  <td className="opt-term  font_14 table_center_text pad-left-23 pad-l-100 nowra_txt">
                                    {isBalanceVisible ? (
                                      <>
                                        {parseFloat(item?.p2phold).toFixed(
                                          4,
                                        )}{" "}
                                      </>
                                    ) : (
                                  ...
                                  <td className="opt-term  font_14 pad-left-23 assnewch_lasttd nowra_txt">
                                    {isBalanceVisible ? (
                                      <>
                                        {parseFloat(
                                          item?.p2p + parseFloat(item?.p2phold),
                                        ).toFixed(4)}
                                      </>
                                    ) : (
                                      "****"
